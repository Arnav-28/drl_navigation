...
class TestTD3(EnvInterface):
    def __init__(self):
        super().__init__("test_td3_agent")
		...
		************************************************"""
        ...
        self.file_name = "td3_agent_seed_40_20250716"
...
def main():
    ...
    try:
        ...
        test_td3.get_logger().info(f"{'Testing is Done':-^35}")
