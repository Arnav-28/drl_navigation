...
def generate_launch_description():
    ...
    *************************************************************************************"""
    ...
    tortoisebot_description_package_name = "tortoisebot_description"
    drl_agent_gazebo_package_directory = get_package_share_directory(
        drl_agent_gazebo_package_name
    )
    tortoisebot_description_package_directory = get_package_share_directory(
        tortoisebot_description_package_name
    )
    ...
    *************************************************************************************"""
    ...
    drl_agent_install_dir_path = (
        get_package_prefix(tortoisebot_description_package_name) + "/share"
    )

    robot_meshes_path = os.path.join(tortoisebot_description_package_directory, "meshes")
    tortoisebot_description_models_path = os.path.join(
        tortoisebot_description_package_directory, "models"
    )
    ...
    gazebo_resource_paths = [
        ...
        drl_agent_install_dir_path,
        robot_meshes_path,
        tortoisebot_description_models_path,
